...
import org.sebi.connection.SSLConnectionFactory;
import org.sebi.connection.DefaultResponseHandler;
...
public class Claim {
    ...
    public void assertXML(String url, String xpath) throws IOException, Exception {
        ...
        String body = SSLConnectionFactory.createTrustSelfSigned().execute(new HttpGet(resolveServiceURL(url)),
